<template>
  <el-card>
    ...
    >
      ...
      <el-table-column prop="courseordernum" label="订单号" :show-overflow-tooltip="true">
      </el-table-column>
      <el-table-column prop="paytype" label="支付类型" width="220">
      </el-table-column>
  
      <el-table-column prop="orderqrcodeurl" label="订单二维码链接" :show-overflow-tooltip="true"> </el-table-column>
          <!-- 状态 -->
